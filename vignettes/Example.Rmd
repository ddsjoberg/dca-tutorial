...
output: 
  html_document:
    includes: 
      in_header: "`r here::here('vignettes', 'highlight', 'header.html')`"
    css: "`r here::here('vignettes', 'highlight', 'styles', 'agate.min.css')`"
vignette: >
...
```{r, include=FALSE}
here::here("vignettes", "rmd_chunks/r-chunks.R") |> knitr::read_chunk()
here::here("vignettes", "rmd_chunks/stata-chunks.do") |> knitr::read_chunk()
```
...
# dca.tutorial::add_tabset_codes("model")
```

```{r, echo=FALSE, results='asis'}
# dca.tutorial::add_tabset_codes("model2")
```
